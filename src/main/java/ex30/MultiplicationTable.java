...
public class MultiplicationTable {
    ...
    public static byte Multiply(int length, int width){
    ...
    public static void main(String[] args) {
        System.out.println("What is the width of the Multiplication Table?");
        int width = input.nextInt();
        System.out.println("What is the length of the Multiplication Table?");
